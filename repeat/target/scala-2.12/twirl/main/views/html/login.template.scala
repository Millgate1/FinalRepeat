...
"""),_display_(/*4.2*/main("Login", user)/*4.21*/ {_display_(Seq[Any](format.raw/*4.23*/("""
    """),format.raw/*5.5*/("""<p class="lead">Client Information</p>
    <div class="col-xs-5">
        <h3>Sign in</h3>
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  SOURCE: /home/wdd/webapps/RepeatCA1/repeat/app/views/login.scala.html
                  HASH: 880108f60aa8ded46f940077efcefbe4bb105fbc
